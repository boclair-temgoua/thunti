...
<a href="${process.env.NODE_CLIENT_URL}" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 19px; font-weight: bold; text-decoration: none; display: inline-block;">
<img src="#" class="logo" alt="${process.env.NODE_NAME}" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none; height: 75px; width: 75px;"/>
</a>
</td>
</tr>
...
<div><div><p>
<strong><span style="color:#444444">INFORMATION CONNEXION:</span></strong>
</p><p><span style="color:#444444">
Username / Email: <a href="mailto:${userRecev.email}" target="_blank">${userRecev.email}</a><br/>
Password: <strong>${userRecev.viewpasswd}</strong><br/>
Se connecter: <a href="${process.env.NODE_CLIENT_ADMIN_URL}/" target="_blank">Se connecter</a>
</p></div></div>
...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; color: #b0adc5; font-size: 12px; text-align: center;">© 2021 - ${new Date().getFullYear()} ${process.env.NODE_NAME}. All rights reserved.</p>
  ...
  const mailOptions = {
    ...
    subject: `New user ${process.env.NODE_NAME}`, // Subject line
    html: output, // html body
    headers: { 'x-cloudmta-class': 'standard' },
  };
  // send mail with defined transport object
  console.log('Message sent: %s', mailOptions.response);
