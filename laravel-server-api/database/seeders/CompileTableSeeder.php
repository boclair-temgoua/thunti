...
use App\Models\abilitypermission;
...
class CompileTableSeeder extends Seeder
{
    ...
    private function addDefaultUtenti()
    {
        ...
        //     'organisationId' => 1,
        //     'countryId' => 1,
        //     'password' => '$2a$12$FriUs8q3LulfKps4B5.QKOHG8WUsDsqvuGUvt3oKlGV18TrRyvsKu', // J2ll5Vd6qMOqzfU
        //     'createdAt' => now(),
        //     'updatedAt' => now(),
        // ]);
	...
	// 		array('code' => 'CM', 'region' => 'Africa','currencyId' => 5,'statusMovesold' => true, 'slug' => str_slug('Cameroon'), 'name' => 'Cameroon'),
	// 		array('code' => 'CV', 'name' => 'Cape Verde'),
	// 		array('code' => 'KY', 'name' => 'Cayman Islands'),
	// 		array('code' => 'CF', 'slug' => str_slug('Central African Republic'), 'name' => 'Central African Republic'),
	...
	// 		array('code' => 'GQ', 'slug' => str_slug('Equatorial Guinea'), 'name' => 'Equatorial Guinea'),
	...
	// 		array('code' => 'FR', 'region' => 'Europe','currencyId' => 2,'statusMovesold' => false, 'slug' => str_slug('France'), 'name' => 'France'),
	...
	// 		array('code' => 'GA', 'slug' => str_slug('Gabon'), 'name' => 'Gabon'),
	...
	// 		array('code' => 'GN', 'region' => 'Africa','currencyId' => 5,'statusMovesold' => false, 'slug' => str_slug('Guinea'), 'name' => 'Guinea'),
	// 		array('code' => 'GW', 'slug' => str_slug('Guinea-Bissau'), 'name' => 'Guinea-Bissau'),
	...
	// 		array('code' => 'IT', 'region' => 'Europe','currencyId' => 2,'statusMovesold' => false, 'slug' => str_slug('Italy'), 'name' => 'Italy'),
	// 		array('code' => 'CI', 'region' => 'Africa','currencyId' => 6,'statusMovesold' => true, 'name' => 'Ivory Coast'),
	...
	// 		array('code' => 'PG', 'slug' => str_slug('Papua New Guinea'), 'name' => 'Papua New Guinea'),
	...
	// 		array('code' => 'SN', 'region' => 'Africa','currencyId' => 6,'statusMovesold' => true, 'name' => 'Senegal'),
